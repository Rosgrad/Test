...
INSERT INTO `category` VALUES (1,'БытХимия'),(2,'Продукты');
...
INSERT INTO `products` VALUES (1,'Хлеб'),(2,'Вода'),(3,'Мыло');
...
INSERT INTO `productscategory` VALUES (1,1),(3,2),(3,2),(6,3);
/*!40000 ALTER TABLE `productscategory` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'zz'
--
...
-- Dump completed on 2022-10-11 13:02:13
